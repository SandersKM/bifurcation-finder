...
class BernotNotebook:
    ...
    def get_tab_children(self):
        ...
        self.source_1_x = self.get_bounded_float_text_widget(0.0, BernotNotebook.MAX_POINT_VALUE)
        self.source_1_y= self.get_bounded_float_text_widget(1.0, BernotNotebook.MAX_POINT_VALUE)
        ...
        self.source_2_x = self.get_bounded_float_text_widget(0.0, BernotNotebook.MAX_POINT_VALUE)
        self.source_2_y= self.get_bounded_float_text_widget(5.0, BernotNotebook.MAX_POINT_VALUE)
        ...
        self.sink_x = self.get_bounded_float_text_widget(4.0, BernotNotebook.MAX_POINT_VALUE)
        self.sink_y = self.get_bounded_float_text_widget(3.0, BernotNotebook.MAX_POINT_VALUE)
